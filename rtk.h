...
#define MAXPRNGPS   35                  /* max satellite PRN number of GPS */
...
#define MAXPRNGAL   35                  /* max satellite PRN number of Galileo */
...
int input_rtcm3(rtcm_t *rtcm, unsigned char data, unsigned int stnID, ppprtk_t *ppprtk);
